...
const welcomeSteps = [
  { image: "image.png", eyebrow: "Start with a little browse", title: "Find something lovely", text: "Shop all, Beauty, Lifestyle, Our story, and Locate us take you to the main parts of the store." },
  { image: "vals.jpg", eyebrow: "Your account", title: "Profile button", text: "Tap your name or avatar to open account settings. Log in appears here when you are signed out." },
  { image: "icon-192.png", eyebrow: "Stay in the loop", title: "Notifications", text: "The bell shows shop updates, delivery messages, and your unread notification count." },
  { image: "image.png", eyebrow: "Keep your favorites close", title: "Wishlist and reviews", text: "The heart saves products for later. Product Reviews lets you read or share thoughts about an item." },
  { image: "cart.png", eyebrow: "Ready when you are", title: "Install and shopping bag", text: "Install App adds Val's Glam to your phone. The bag holds your items and opens secure checkout." },
  { image: "settings.png", eyebrow: "Personalize your visit", title: "Settings preferences", text: "Settings controls Currency, Language, Theme, and Cosmetic animations. Choose what feels right for you." },
  { image: "settings.png", eyebrow: "Your account settings", title: "Updates, password, and history", text: "Order updates and Offers control messages. Change password protects your account. View transactions shows purchases, and Log out ends your session." }
];
const translations = {
